...
| Вход в админку: пароль 1122 (Ctrl+Shift+A или ссылка в подвале), «Неверный пароль» при ошибке, сессия в sessionStorage | ✅ | ✅ |
| Админ-панель: курсы USD→THB и RUB→THB, валидация, авто-сохранение | ✅ | ✅ |
